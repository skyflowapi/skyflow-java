...
/**
 * Skyflow Deidentify File Async Example
 * <p>
 * This example demonstrates how to use the Skyflow SDK to deidentify file in an asynchronous manner.
 ...
 */
public class DeidentifyFileExampleAsync {
    ...
    public static void main(String[] args) throws SkyflowException {
        ...
        CompletableFuture<Void> future = CompletableFuture.supplyAsync(() -> {
            try {
                return skyflowClient.detect(vaultConfig.getVaultId()).deidentifyFile(deidentifyFileRequest);
            } catch (SkyflowException e) {
                throw new RuntimeException(e);
            }
        }).thenAccept(response -> {
            System.out.println("Deidentify file response: " + response.toString());
