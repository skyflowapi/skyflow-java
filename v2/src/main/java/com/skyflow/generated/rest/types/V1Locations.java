...
@JsonDeserialize(builder = V1Locations.Builder.class)
public final class V1Locations {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof V1Locations && equalTo((V1Locations) other);
    }
    ...
    private boolean equalTo(V1Locations other) {
    ...
    public static final class Builder {
        ...
        public Builder from(V1Locations other) {
        ...
        public V1Locations build() {
            return new V1Locations(startIndex, endIndex, startIndexProcessed, endIndexProcessed, additionalProperties);
        }
    }
}
