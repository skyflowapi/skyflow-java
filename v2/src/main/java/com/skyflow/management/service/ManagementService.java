package com.skyflow.management.service;
...
public class ManagementService {
    ...
    public static ManagementService initialize() {
        // return management object
        return null;
    }

    public T createVault() {
    ...
    public T vault(String vaultId) {
        // return vault object from the cached list
        return null;
    }

    public T role(String roleId) {
        // return role object from the cached list
        return null;
    }

    public T policy(String policyId) {
