...
@JsonDeserialize(builder = DeidentifyFileRequestDeidentifyDocument.Builder.class)
public final class DeidentifyFileRequestDeidentifyDocument {
    private final FileDataDeidentifyDocument file;

    private final String vaultId;

    private final Optional<List<DeidentifyFileRequestDeidentifyDocumentEntityTypesItem>> entityTypes;
    ...
    private DeidentifyFileRequestDeidentifyDocument(
            FileDataDeidentifyDocument file,
            String vaultId,
            Optional<List<DeidentifyFileRequestDeidentifyDocumentEntityTypesItem>> entityTypes,
    ...
    @JsonProperty("file")
    public FileDataDeidentifyDocument getFile() {
        return file;
    }
    ...
    public Optional<List<DeidentifyFileRequestDeidentifyDocumentEntityTypesItem>> getEntityTypes() {
        return entityTypes;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeidentifyFileRequestDeidentifyDocument
                && equalTo((DeidentifyFileRequestDeidentifyDocument) other);
    }
    ...
    private boolean equalTo(DeidentifyFileRequestDeidentifyDocument other) {
    ...
    public interface FileStage {
        VaultIdStage file(@NotNull FileDataDeidentifyDocument file);

        Builder from(DeidentifyFileRequestDeidentifyDocument other);
    }
    ...
    public interface _FinalStage {
        DeidentifyFileRequestDeidentifyDocument build();

        /**
         * <p>Entities to detect and de-identify.</p>
         */
        _FinalStage entityTypes(Optional<List<DeidentifyFileRequestDeidentifyDocumentEntityTypesItem>> entityTypes);

        _FinalStage entityTypes(List<DeidentifyFileRequestDeidentifyDocumentEntityTypesItem> entityTypes);
    ...
    public static final class Builder implements FileStage, VaultIdStage, _FinalStage {
        private FileDataDeidentifyDocument file;
        ...
        private Optional<List<DeidentifyFileRequestDeidentifyDocumentEntityTypesItem>> entityTypes = Optional.empty();
         ...
         */
        @java.lang.Override
        public _FinalStage entityTypes(List<DeidentifyFileRequestDeidentifyDocumentEntityTypesItem> entityTypes) {
