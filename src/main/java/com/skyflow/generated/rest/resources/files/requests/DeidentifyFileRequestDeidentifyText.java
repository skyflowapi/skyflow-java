...
@JsonDeserialize(builder = DeidentifyFileRequestDeidentifyText.Builder.class)
public final class DeidentifyFileRequestDeidentifyText {
    private final FileDataDeidentifyText file;

    private final String vaultId;

    private final Optional<List<DeidentifyFileRequestDeidentifyTextEntityTypesItem>> entityTypes;
    ...
    private DeidentifyFileRequestDeidentifyText(
            FileDataDeidentifyText file,
            String vaultId,
            Optional<List<DeidentifyFileRequestDeidentifyTextEntityTypesItem>> entityTypes,
    ...
    @JsonProperty("file")
    public FileDataDeidentifyText getFile() {
        return file;
    }
    ...
    public Optional<List<DeidentifyFileRequestDeidentifyTextEntityTypesItem>> getEntityTypes() {
        return entityTypes;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeidentifyFileRequestDeidentifyText
                && equalTo((DeidentifyFileRequestDeidentifyText) other);
    }
    ...
    private boolean equalTo(DeidentifyFileRequestDeidentifyText other) {
    ...
    public interface FileStage {
        VaultIdStage file(@NotNull FileDataDeidentifyText file);

        Builder from(DeidentifyFileRequestDeidentifyText other);
    }
    ...
    public interface _FinalStage {
        DeidentifyFileRequestDeidentifyText build();

        /**
         * <p>Entities to detect and de-identify.</p>
         */
        _FinalStage entityTypes(Optional<List<DeidentifyFileRequestDeidentifyTextEntityTypesItem>> entityTypes);

        _FinalStage entityTypes(List<DeidentifyFileRequestDeidentifyTextEntityTypesItem> entityTypes);
    ...
    public static final class Builder implements FileStage, VaultIdStage, _FinalStage {
        private FileDataDeidentifyText file;
        ...
        private Optional<List<DeidentifyFileRequestDeidentifyTextEntityTypesItem>> entityTypes = Optional.empty();
         ...
         */
        @java.lang.Override
        public _FinalStage entityTypes(List<DeidentifyFileRequestDeidentifyTextEntityTypesItem> entityTypes) {
        ...
        public _FinalStage entityTypes(Optional<List<DeidentifyFileRequestDeidentifyTextEntityTypesItem>> entityTypes) {
            this.entityTypes = entityTypes;
            return this;
        }
