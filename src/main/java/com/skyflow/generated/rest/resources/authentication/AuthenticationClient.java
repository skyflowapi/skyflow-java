    ...
    public V1GetAuthTokenResponse authenticationServiceGetAuthToken(
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), V1GetAuthTokenResponse.class);
            }
            ...
            try {
                switch (response.code()) {
                    ...
                    case 401:
                        throw new UnauthorizedError(ObjectMappers.JSON_MAPPER.readValue(
                                responseBodyString, new TypeReference<Map<String, Object>>() {}));
                    case 404:
