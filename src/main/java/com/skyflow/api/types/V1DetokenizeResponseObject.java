...
@JsonDeserialize(builder = V1DetokenizeResponseObject.Builder.class)
public final class V1DetokenizeResponseObject {
    ...
    private V1DetokenizeResponseObject(
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof V1DetokenizeResponseObject && equalTo((V1DetokenizeResponseObject) other);
    }
    ...
    private boolean equalTo(V1DetokenizeResponseObject other) {
    ...
    public static final class Builder {
        ...
        public Builder from(V1DetokenizeResponseObject other) {
        ...
        public V1DetokenizeResponseObject build() {
            return new V1DetokenizeResponseObject(
