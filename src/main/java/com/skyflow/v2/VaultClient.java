...
import com.skyflow.v2.generated.rest.resources.strings.types.ReidentifyStringRequestFormat;
...
public class VaultClient {
    ...
    private Transformations getTransformations(com.skyflow.v2.vault.detect.Transformations transformations) {
    ...
    protected com.skyflow.v2.generated.rest.resources.files.requests.DeidentifyTextRequest getDeidentifyTextFileRequest(DeidentifyFileRequest request, String vaultId, String base64Content){
        ...
        com.skyflow.v2.generated.rest.resources.files.requests.DeidentifyTextRequest req =
                com.skyflow.v2.generated.rest.resources.files.requests.DeidentifyTextRequest.builder()
                        .vaultId(vaultId)
                        .file(file)
                        .entityTypes(mappedEntityTypes)
                        .tokenType(tokenType)
    ...
    protected com.skyflow.v2.generated.rest.resources.files.requests.DeidentifyFileRequest getDeidentifyGenericFileRequest(
        ...
        return com.skyflow.v2.generated.rest.resources.files.requests.DeidentifyFileRequest.builder()
                .vaultId(vaultId)
                .file(file)
                .entityTypes(mappedEntityTypes)
                .tokenType(tokenType)
