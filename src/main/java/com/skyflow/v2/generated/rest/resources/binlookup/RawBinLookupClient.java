...
public class RawBinLookupClient {
    protected final ClientOptions clientOptions;

    public RawBinLookupClient(ClientOptions clientOptions) {
     ...
     */
    public ApiClientHttpResponse<V1BinListResponse> binListServiceListCardsOfBin() {
     ...
     * &lt;b&gt;Note&lt;/b&gt;: This endpoint is in beta and subject to change. &lt;br&gt;&lt;br&gt; Returns the specified card metadata.
     */
    public ApiClientHttpResponse<V1BinListResponse> binListServiceListCardsOfBin(V1BinListRequest request) {
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            if (response.isSuccessful()) {
                return new ApiClientHttpResponse<>(
                        ObjectMappers.JSON_MAPPER.readValue(responseBody.string(), V1BinListResponse.class), response);
            }
