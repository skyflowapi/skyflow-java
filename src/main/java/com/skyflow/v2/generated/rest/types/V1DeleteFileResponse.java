...
@JsonDeserialize(builder = V1DeleteFileResponse.Builder.class)
public final class V1DeleteFileResponse {
    ...
    /**
     * @return If <code>true</code>, the file was deleted.
     */
    ...
    private boolean equalTo(V1DeleteFileResponse other) {
    ...
    public static final class Builder {
        ...
        public Builder from(V1DeleteFileResponse other) {
        ...
        /**
         * <p>If <code>true</code>, the file was deleted.</p>
         */
        ...
        public V1DeleteFileResponse build() {
            return new V1DeleteFileResponse(skyflowId, deleted, additionalProperties);
        }
    }
}
