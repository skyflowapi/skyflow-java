...
import com.skyflow.v2.generated.rest.resources.files.types.DeidentifyPresentationRequestFile;
...
@JsonDeserialize(builder = DeidentifyPresentationRequest.Builder.class)
public final class DeidentifyPresentationRequest {
    private final String vaultId;

    private final DeidentifyPresentationRequestFile file;
    ...
    private DeidentifyPresentationRequest(
            String vaultId,
            DeidentifyPresentationRequestFile file,
     ...
     */
    @JsonProperty("file")
    public DeidentifyPresentationRequestFile getFile() {
        return file;
    }
    ...
    private boolean equalTo(DeidentifyPresentationRequest other) {
    ...
    public interface VaultIdStage {
        ...
        Builder from(DeidentifyPresentationRequest other);
    }
    ...
    public interface _FinalStage {
        DeidentifyPresentationRequest build();
    ...
    public static final class Builder implements VaultIdStage, FileStage, _FinalStage {
        ...
        private DeidentifyPresentationRequestFile file;
