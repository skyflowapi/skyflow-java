...
import com.skyflow.v2.generated.rest.resources.files.types.DeidentifyDocumentRequestFile;
...
@JsonDeserialize(builder = DeidentifyDocumentRequest.Builder.class)
public final class DeidentifyDocumentRequest {
    ...
    public interface VaultIdStage {
        ...
        Builder from(DeidentifyDocumentRequest other);
    }
    ...
    public interface FileStage {
         ...
         */
        _FinalStage file(@NotNull DeidentifyDocumentRequestFile file);
    }
    ...
    public static final class Builder implements VaultIdStage, FileStage, _FinalStage {
        ...
        private DeidentifyDocumentRequestFile file;
