...
@JsonDeserialize(builder = DeidentifyStructuredTextRequestFile.Builder.class)
public final class DeidentifyStructuredTextRequestFile {
    private final String base64;

    private final DeidentifyStructuredTextRequestFileDataFormat dataFormat;

    private final Map<String, Object> additionalProperties;

    private DeidentifyStructuredTextRequestFile(
            String base64,
            DeidentifyStructuredTextRequestFileDataFormat dataFormat,
    ...
    public DeidentifyStructuredTextRequestFileDataFormat getDataFormat() {
        return dataFormat;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof DeidentifyStructuredTextRequestFile
                && equalTo((DeidentifyStructuredTextRequestFile) other);
    }
    ...
    private boolean equalTo(DeidentifyStructuredTextRequestFile other) {
    ...
    public interface Base64Stage {
        ...
        Builder from(DeidentifyStructuredTextRequestFile other);
    }
    ...
    public interface DataFormatStage {
         ...
         */
        _FinalStage dataFormat(@NotNull DeidentifyStructuredTextRequestFileDataFormat dataFormat);
    }

    public interface _FinalStage {
        DeidentifyStructuredTextRequestFile build();
    }
    ...
    public static final class Builder implements Base64Stage, DataFormatStage, _FinalStage {
        ...
        private DeidentifyStructuredTextRequestFileDataFormat dataFormat;
