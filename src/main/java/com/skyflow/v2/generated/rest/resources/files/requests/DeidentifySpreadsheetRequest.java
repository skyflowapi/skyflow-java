...
import com.skyflow.v2.generated.rest.resources.files.types.DeidentifySpreadsheetRequestFile;
...
@JsonDeserialize(builder = DeidentifySpreadsheetRequest.Builder.class)
public final class DeidentifySpreadsheetRequest {
    private final String vaultId;

    private final DeidentifySpreadsheetRequestFile file;
    ...
    private DeidentifySpreadsheetRequest(
            String vaultId,
            DeidentifySpreadsheetRequestFile file,
     ...
     */
    @JsonProperty("file")
    public DeidentifySpreadsheetRequestFile getFile() {
        return file;
    }
    ...
    private boolean equalTo(DeidentifySpreadsheetRequest other) {
    ...
    public interface VaultIdStage {
        ...
        Builder from(DeidentifySpreadsheetRequest other);
    }
    ...
    public interface FileStage {
         ...
         */
        _FinalStage file(@NotNull DeidentifySpreadsheetRequestFile file);
    }

    public interface _FinalStage {
        DeidentifySpreadsheetRequest build();
    ...
    public static final class Builder implements VaultIdStage, FileStage, _FinalStage {
        ...
        private DeidentifySpreadsheetRequestFile file;
