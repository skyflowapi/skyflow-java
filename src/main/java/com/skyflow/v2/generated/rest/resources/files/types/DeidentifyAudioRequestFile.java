...
@JsonDeserialize(builder = DeidentifyAudioRequestFile.Builder.class)
public final class DeidentifyAudioRequestFile {
    private final String base64;

    private final DeidentifyAudioRequestFileDataFormat dataFormat;

    private final Map<String, Object> additionalProperties;

    private DeidentifyAudioRequestFile(
            String base64, DeidentifyAudioRequestFileDataFormat dataFormat, Map<String, Object> additionalProperties) {
        this.base64 = base64;
    ...
    public DeidentifyAudioRequestFileDataFormat getDataFormat() {
        return dataFormat;
    }
    ...
    private boolean equalTo(DeidentifyAudioRequestFile other) {
    ...
    public interface Base64Stage {
        ...
        Builder from(DeidentifyAudioRequestFile other);
    }
    ...
    public interface DataFormatStage {
         ...
         */
        _FinalStage dataFormat(@NotNull DeidentifyAudioRequestFileDataFormat dataFormat);
    }

    public interface _FinalStage {
        DeidentifyAudioRequestFile build();
    }
    ...
    public static final class Builder implements Base64Stage, DataFormatStage, _FinalStage {
        ...
        private DeidentifyAudioRequestFileDataFormat dataFormat;
