...
@JsonDeserialize(builder = DeidentifyPresentationRequestFile.Builder.class)
public final class DeidentifyPresentationRequestFile {
    private final String base64;

    private final DeidentifyPresentationRequestFileDataFormat dataFormat;

    private final Map<String, Object> additionalProperties;

    private DeidentifyPresentationRequestFile(
            String base64,
            DeidentifyPresentationRequestFileDataFormat dataFormat,
    ...
    public DeidentifyPresentationRequestFileDataFormat getDataFormat() {
        return dataFormat;
    }
    ...
    private boolean equalTo(DeidentifyPresentationRequestFile other) {
    ...
    public interface Base64Stage {
        ...
        Builder from(DeidentifyPresentationRequestFile other);
    }
    ...
    public interface DataFormatStage {
         ...
         */
        _FinalStage dataFormat(@NotNull DeidentifyPresentationRequestFileDataFormat dataFormat);
    }

    public interface _FinalStage {
        DeidentifyPresentationRequestFile build();
    }
    ...
    public static final class Builder implements Base64Stage, DataFormatStage, _FinalStage {
        ...
        private DeidentifyPresentationRequestFileDataFormat dataFormat;
