...
public class AsyncApiClientBuilder {
    ...
    public AsyncApiClientBuilder vaultUrl(String vaultUrl) {
    ...
    protected void setEnvironment(ClientOptions.Builder builder) {
        if (this.vaultUrl != null) {
            String _vaultUrl = this.vaultUrl != null ? this.vaultUrl : "{{vault_url}}";
            this.environment = Environment.custom("https://{vault_url}".replace("{vault_url}", _vaultUrl));
        }
